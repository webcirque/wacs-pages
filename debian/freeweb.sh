#/usr/bin/sh
echo Tor and I2Pd installation script ported to Debian Buster by EdChdX. May work on Bullseye and Sid as well.
cd /etc/
echo Detecting your version...
debVer=$(dpkg --status tzdata|grep Provides|cut -f2 -d'-')
echo "You are using Debian $debVer"
...
if [ "$updDebRepo" == "y" ] ; then
	...
	echo "deb https://deb.torproject.org/torproject.org $debVer main">> apt/sources.list.d/freeweb.list
	echo "deb-src https://deb.torproject.org/torproject.org $debVer main">> apt/sources.list.d/freeweb.list
	echo "OK."
	printf "Adding keys for Tor...	"
	curl https://deb.torproject.org/torproject.org/A3C4F0F979CAA22CDBA8F512EE8CBC9E886DDD89.asc | gpg --import
	gpg --export A3C4F0F979CAA22CDBA8F512EE8CBC9E886DDD89 | apt-key add -
	echo "Adding source for I2Pd...	"
	echo "# Used by I2Pd">> apt/sources.list.d/freeweb.list
	echo "deb https://repo.i2pd.xyz/debian $debVer main">> apt/sources.list.d/freeweb.list
	echo "deb-src https://repo.i2pd.xyz/debian $debVer main">> apt/sources.list.d/freeweb.list
	printf "Adding keys for I2Pd..."
	curl -sL https://repo.i2pd.xyz/r4sas.gpg | apt-key add -
